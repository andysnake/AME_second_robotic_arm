...
void Move_Group_Robot_1::move_to_configuration(std::vector<double>& joint_angles)
{
  ...
  std::vector<double> target_joint_angles = {0, -1.5707963, 2.094395067, 0, 0, 0};
  ...
  ur5_robot1_group_ptr->setJointValueTarget(target_joint_angles);
  // ur5_robot1_group_ptr->setPoseTarget()
  ...
  // ur5_robot1_group_ptr->setStartStateToCurrentState();
  // ur5_robot1_group_ptr->setJointValueTarget(target_joint_angles_2);


  // success = (ur5_robot1_group_ptr->plan(ur5_robot1_goal_plan) == moveit::planning_interface::MoveItErrorCode::SUCCESS);
...
int main(int argc, char** argv)
{
  ...
  std::cout<<"Executing joint angles [0, 1.5707963, 0, 0, 0, 0] \n";
  
  std::vector<double> target_joint_angles = {0, 1.5707963, 0, 0, 0, 0};
